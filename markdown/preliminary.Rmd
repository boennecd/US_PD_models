...
(function(){
  ...
  print(summary(fit))
  for(i in 0:3)
    vis.gam(fit, c("rel_size", "actq_defl_log"), theta=-35 + 90 * i, 
            ticktype = "detailed", color = "gray")
  
  # show kernel density plot to strees that there is mainly data in some 
  # regions
  library(MASS)
  dens <- kde2d(dat_use$rel_size, dat_use$actq_defl_log, n = 100) 
  image(dens, col = colorRampPalette(brewer.pal(7, "Blues"))(30), 
        xlab = "rel_size", ylab = "actq_defl_log")
})()
```
